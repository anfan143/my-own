...
DROP FUNCTION IF EXISTS public.handle_provider_completion();
DROP FUNCTION IF EXISTS public.refresh_provider_completion_status();
...
CREATE FUNCTION public.refresh_provider_completion_status()
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
...
CREATE FUNCTION public.handle_provider_completion()
RETURNS trigger
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = public
