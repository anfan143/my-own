...
BEGIN
  ...
  EXECUTE 'ALTER FUNCTION check_role_access SET search_path = ''public''';
  EXECUTE 'ALTER FUNCTION check_role_permission SET search_path = ''public''';
  EXECUTE 'ALTER FUNCTION check_provider_access SET search_path = ''public''';
  EXECUTE 'ALTER FUNCTION check_total_payment_percentage SET search_path = ''public''';
  EXECUTE 'ALTER FUNCTION calculate_provider_completion SET search_path = ''public''';
  EXECUTE 'ALTER FUNCTION generate_project_number SET search_path = ''public''';
  EXECUTE 'ALTER FUNCTION handle_permission_error SET search_path = ''public''';
  EXECUTE 'ALTER FUNCTION handle_proposal_acceptance SET search_path = ''public''';
  EXECUTE 'ALTER FUNCTION handle_updated_at SET search_path = ''public''';
  EXECUTE 'ALTER FUNCTION log_permission_error SET search_path = ''public''';
  EXECUTE 'ALTER FUNCTION prefill_provider_data SET search_path = ''public''';
  EXECUTE 'ALTER FUNCTION refresh_provider_completion_status SET search_path = ''public''';
  EXECUTE 'ALTER FUNCTION storage.foldername SET search_path = ''storage''';
  EXECUTE 'ALTER FUNCTION sync_shared_profile_data SET search_path = ''public''';
  EXECUTE 'ALTER FUNCTION track_role_switch SET search_path = ''public''';
  EXECUTE 'ALTER FUNCTION validate_profile_data SET search_path = ''public''';
  EXECUTE 'ALTER FUNCTION validate_provider_data SET search_path = ''public''';
  EXECUTE 'ALTER FUNCTION validate_provider_update SET search_path = ''public''';
  EXECUTE 'ALTER FUNCTION validate_role_switch SET search_path = ''public''';
END $$;
